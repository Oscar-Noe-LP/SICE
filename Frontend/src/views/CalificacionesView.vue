    ...
    <div class="calificaciones-page">
      ...
      <div v-if="alumnoHistorial" class="historial-card">
        <div class="historial-encabezado">
          <div class="historial-avatar" :class="{ 'sin-calificar': esNC(alumnoHistorial) }">
            {{ iniciales(alumnoHistorial.nombre) }}
          </div>
          ...
          >
            ...
            <div class="parcial-barra-wrap">
              <div class="parcial-barra">
                <div class="parcial-fill" :style="{ width: (val / 10 * 100) + '%', background: colorNota(Number(val)) }"></div>
              </div>
            </div>
          ...
          <div v-for="mat in materiasResumen" :key="mat.nombre" class="ind-card">
            ...
            <div class="ind-promedio-row">
              ...
              <div class="ind-barra-v">
                <div class="ind-barra-fill" :style="{ height: (mat.promedio / 10 * 100) + '%', background: colorNota(Number(mat.promedio)) }"></div>
              </div>
            </div>
...
.btn-accion.historial { background: #F5F5F5; color: #6B7280; } .btn-accion.historial:hover { background: #E5E7EB; }
