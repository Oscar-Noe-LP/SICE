...
<template>
  <MainLayout v-slot="{ busquedaGlobal }">
    <div class="comite-page">
      ...
      <!-- ── TARJETAS KPI ── -->
      <div class="kpi-grid">
        <div class="kpi-card card-acento-azul">
          <div class="kpi-icono">
        ...
        <div class="kpi-card card-acento-verde">
          <div class="kpi-icono">
        ...
        <div class="kpi-card card-acento-naranja">
          <div class="kpi-icono">
      ...
      <div class="listas-grid">
        ...
        <div class="lista-card">
          <div class="lista-cabecera">
            ...
            <button @click="router.push('/comite/solicitudes')" class="btn-secundario">Ver todas</button>
          </div>
        ...
        <div class="lista-card">
          <div class="lista-cabecera">
            ...
            <button @click="router.push('/comite/sesiones')" class="btn-secundario">Ver todas</button>
          </div>
          <div class="lista-cuerpo">
            <div
            ...
            >
              ...
              <button @click="router.push(`/comite/resoluciones?sesion=${ses.id}`)" class="btn-accion ver">
                Ver
              </button>
            </div>
...
.card-acento-azul    { border-left: 4px solid #1B396A; }
.card-acento-verde   { border-left: 4px solid #16A34A; }
.card-acento-naranja { border-left: 4px solid #F59E0B; }

.kpi-icono {
  width: 48px; height: 48px; border-radius: 12px;
  display: flex; align-items: center; justify-content: center;
}
.kpi-card.card-acento-azul    .kpi-icono { background: #DBEAFE; }
.kpi-card.card-acento-verde   .kpi-icono { background: #DCFCE7; }
.kpi-card.card-acento-naranja .kpi-icono { background: #FEF3C7; }
